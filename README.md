...
project you have to select the highest module `sathish-test-spring-web` as the classpath.
...
```
java -Dspring.profiles.active=production -jar ./sathish-test-spring-web/target/sathish-test-spring-web-0.0.1-SNAPSHOT.jar
```
...
```
mvnw spring-boot:build-image -Dspring-boot.build-image.imageName=me.sathish.allsummer/sathish-test-spring
```
